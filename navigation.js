$(function(){
	var menuLinks = `<a style="color: #fff; padding: 5px;" href="/">Главная</a>
					<a style="color: #fff; padding: 5px;" href="reviews.html">Отзывы</a>
					<a style="color: #fff; padding: 5px;" href="vebinar.html">ВЕБИНАР</a>
					<a style="color: #fff; padding: 5px;" href="course.html">КУРС</a>
					<a style="color: #fff; padding: 5px;" href="blog-inner.html">Блог внутреняя</a>
					<a style="color: #fff; padding: 5px;" href="blog.html">Блог</a>`;
